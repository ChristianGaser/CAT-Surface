...
\n\
    Smooth a volume with an isotropic Gaussian of -fwhm mm.  The output is\n\
    written next to the input with an s<fwhm> prefix when no output name is\n\
    given.\n\
\n\
