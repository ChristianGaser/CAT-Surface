...
static ArgvInfo argTable[] = {
    ...
    {"-blood-vessel-correction", ARGV_CONSTANT, (char *)1, (char *)&blood_vessel_correction,
     "Apply blood-vessel correction on the input PVE map before all other operations."},
...
int main(int argc, char *argv[])
{
    ...
    if (blood_vessel_correction)
    {
        ...
        blood_vessel_correction_pve_float(src, dims, voxelsize, NULL);
    }
