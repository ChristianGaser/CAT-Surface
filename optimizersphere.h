extern void fmg2(int n0[], double *a0, double *b0, int rtype, double param[],
                 int c, int nit, double *u0, double *scratch);
extern void cgs2(int dm[], double A[], double b[], int rtype, double param[],
                 double tol, int nit, double x[], double r[],
                 double p[], double Ap[]);
