...
*/
    ...
    __pyx_v_std_map = values[25];
    if (values[26]) {
      __pyx_v_std_exp = __Pyx_PyFloat_AsDouble(values[26]); if (unlikely((__pyx_v_std_exp == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 56, __pyx_L3_error)
    } else {
